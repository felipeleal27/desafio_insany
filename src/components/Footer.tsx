        ...
        <div className="max-w-6xl mx-auto flex flex-wrap justify-between gap-8 px-4">
          ...
          <div className="md:w-1/3">
            ...
            <div className="mt-4 bg-white p-2 rounded-md flex items-center shadow-md w-[486px] h-[64px]">
              ...
              />
              <button className="bg-blue-600 text-white px-6 py-2 rounded-md">Receber novidades</button>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/6">
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-white hover:text-blue-600">Quero ser cliente</a>
              </li>
              <li>
                <a href="#" className="text-white hover:text-blue-600">Acessar conta</a>
              </li>
              <li>
                <a href="#" className="text-white hover:text-blue-600">Dúvidas</a>
              </li>
              <li>
                <a href="#" className="text-white hover:text-blue-600">Termos e condições</a>
              </li>
              <li>
                <a href="#" className="text-white hover:text-blue-600">Fale conosco</a>
              </li>
            </ul>
          </div>

    ...
    <div className="bg-white py-16">
      ...
      >
        ...
        <div className="flex-1">
          ...
          {/* Ícones com texto */}
            <div className={`flex flex-col space-y-4 ${isMobile ? "items-center" : ""}`}>
            <div className="flex items-center">
              ...
              />
              <span
              className={`ml-4 text-gray-700 ${isMobile ? "text-sm text-center" : ""}`}
              >
          ...
          <button
            className={`bg-blue-600 text-white py-2 px-6 rounded-md mt-6 hover:bg-blue-700 transition ${
          ...
          {/* Ícone de Fale Conosco */}
            <div className={`mt-6 flex items-center text-blue-600 ${isMobile ? "justify-center" : ""}`}>
            <Image
